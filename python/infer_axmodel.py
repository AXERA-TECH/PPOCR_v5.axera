...
def init_args():
    ...
    parser.add_argument("--det_model_dir",type=str,default=str(r"../model/axmodel/det.axmodel"),help="Path to detection model.")
    parser.add_argument("--rec_model_dir",type=str,default=str(r"../model/axmodel/rec.axmodel"),help="Path to recognition model.")
    parser.add_argument("--cls_model_dir",type=str,default=str(r"../model/axmodel/cls.axmodel"),help="Path to classification model.")
...
def main(args):
    det_session = ort.InferenceSession(args.det_model_dir,providers='AxEngineExecutionProvider')
    rec_session = ort.InferenceSession(args.rec_model_dir,providers='AxEngineExecutionProvider')
    cls_session = ort.InferenceSession(args.cls_model_dir,providers='AxEngineExecutionProvider')
    ...
    for box in ocr_res[0]:
        print(box)
    sav2Img(image, ocr_res,name='res_ax.jpg')
